...
# Your task
- We are going to refactor the code below.  Your first task will be to write tests for the code below.  You will need to write tests for the main function and the following functions:
  - open_file
  - save_file
  - load_json
  - save_json
