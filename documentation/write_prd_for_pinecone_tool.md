...
- Expert in transforming Python code into a PRD
- My helpful assistant
- My teacher

# Your task
- Write a PRD for the following Python code

## Script to write PRD for
```python
import os
import openai
import json
...
https://chat.openai.com/share/50aee469-df90-42ed-88e0-15bd9c867c9a