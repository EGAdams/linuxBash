...
### these need to be defined before we build the tools array ###
...
### Now we can build the tools array ###
tools = [
    Tool(
        name="shell",
        func=shell_function,
...
### continue from https://python.langchain.com/docs/modules/memory/agent_with_memory
