...
if __name__ == '__main__':
    ...
    while True:
        ...
        unique_id = str(uuid4())
        metadata = {'speaker': 'RAVEN', 'time': timestamp, 'message': ai_completion_text, 'timestring': timestring, 'uuid': unique_id}
        
        # Insert AI's response to lancedb
        tbl.add([(unique_id, embedded_ai_completion, metadata)])
